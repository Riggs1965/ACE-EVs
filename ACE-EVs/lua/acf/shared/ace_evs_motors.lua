-- Define ACE Electric Motors after ACF is initialized
hook.Add("ACF_PostLoad", "ACE_EVs_RegisterMotors", function()
    print("[ACE EVs] Registering electric motors...")

    -- Register the Electric Engine Class
    ...
    print("[ACE EVs] Electric motors registered successfully!")
end)